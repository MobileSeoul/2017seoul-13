...
<tr>
<td style="height:60px;border-bottom:1px solid #CCC;"><i class="glyphicon glyphicon-map-marker"></i>장소
...
<td style="border-bottom:1px solid #CCC; "colspan="2"><input style="border:0px;margin-top:px;width:100%;height:40px;" value="" name="wr_2" id="wr_2" value="<?php echo $write['wr_2'] ?>" required maxlength="255" class="g_text" /></td>
