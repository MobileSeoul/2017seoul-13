...
$xml = simplexml_load_file("https://maps.google.com/maps/api/geocode/xml?address=".urlencode($address)."&language=ko&sensor=false"); 
...
<div style="background-color:#F0F2F9; list-style:none; margin:10px;">
<div style="background-color:#fff;   height:110px; border:1px solid #ECEEF0; ">

<div class="left" style="float:left; width:110px;">

<img src="https://ggnamu.com/img/<?= $view['wr_id']?>.jpg" style="width: 110px;height:110px;">

</div>

<div class="right" style="float:left; width:100%-110px; margin-left:10px;">
<p style="text-align:center;font-size:14px; font-weight:bold; padding:5px;margin-top:10px;color:#D21279;line-height:18px; color:#FFF; background-color:#DA1328; width:85px;font-family:맑은고딕;">착한가게</p>
<p style="font-size:16px;font-weight:bold; word-break:normal; line-height:16px; 
			color:#000; background-color:#FFFFFF; font-family:맑은고딕;">
<p style="margin-top:15px; font-family:맑은고딕; line-height:15px; font-weight:bold;padding-bottom:10px;font-size:15px; margin-bottom:5px;"><?php echo cut_str(get_text($view['wr_subject']), 70); // 글제목 출력?>
</p></p>


<p style="font-size:16px;word-break:normal; line-height:16px; 
			color:#000; background-color:#FFFFFF; font-family:맑은고딕;"><p style="margin-bottom:10px;padding-bottom:10px;margin-top:5px;  font-family:맑은고딕; line-height:15px; font-size:15px; ">
<?echo $view['wr_3'];?>
</p>
</p>
...
{ 
 if (GBrowserIsCompatible())
 {
  ...
  showAddress("<?=$view['wr_3']?>"); //실제 주소를 날리고 좌표를 콜백받아 처리할 함수
 }
}
...
<p style="border-bottom:1px solid #EFEFEF; padding-bottom:10px;margin-top:10px;  font-family:맑은고딕; line-height:15px; font-size:15px; margin:0 10px 0 10px;">인스타그램</p>
<style>
.blind{display:none;}
/* 
	InstaLink
