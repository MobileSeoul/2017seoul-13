...
<div id="bo_vc" class="cmt_wrap">
    <div class="cmt_top">
		<div class="cmt_top_title"<? if($view['wr_comment'] == 0){?>style="padding-bottom:0"<?}?>>댓글 <span><strong><?=$view['wr_comment'] ?></strong></span></div>
	</div>
    ...
    <li id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="padding-left:<?php echo $cmt_depth ?>px" class="dcmt"<?php } ?>>
		...
		<div class="repd">
			 ...
			 ?>
			<?php if ($list[$i]['is_reply']) { ?><a class="iurl2" href="<?php echo $c_reply_href;  ?>" onclick="comment_box('<?php echo $comment_id ?>', 'c'); return false;"><span class="glyphicon glyphicon-comment"></span> 답글</a><?php } ?>
			<?php if ($list[$i]['is_edit']) { ?><a class="iurl2" href="<?php echo $c_edit_href;  ?>" onclick="comment_box('<?php echo $comment_id ?>', 'cu'); return false;"><span class="glyphicon glyphicon-edit"></span> 수정</a><?php } ?>
			<?php if ($list[$i]['is_del'])  { ?><a class="iurl2" href="<?php echo $list[$i]['del_link'];  ?>" onclick="return comment_delete();"><span class="glyphicon glyphicon-trash"></span> 삭제</a><?php } ?>
		   <?php } ?>
		   </div>
