...
===========================================================
	...
	작성날짜 : 2015년 08월 02일 일요일 오전 06시 30분 - 날씨 소나기 내림, 밝기는 한데
...
*/
	...
	# 시작 => 프로그램_정보__입력하기
	#########################################################
	function save__piree__program_info()
	{
			...
			//===================================================
			// 외부_상수__전역_변수
			global $g_program_n, $g_program_c, $g_program_s, $g_program_version_s, $piree, $is_paid, $prog_memo_s;
			...
			//===================================================
			// 프로그램__코드
			$prog_c = trim($g_program_c .' '. $g_program_version_s);


			//===================================================
			// 프로그램__이름
			$prog_s = trim($g_program_s .' '. $g_program_version_s);
